<?php
/**
 * @package plugin.system browsertitleghsvs for Joomla! ge 3.9.0
 * @version See browsertitleghsvs.xml
 * @author G@HService Berlin Neukölln, Volkmar Volli Schlothauer (GHSVS.de)
 * @copyright Copyright (C) 2015-2019, G@HService Berlin Neukölln, Volkmar Volli Schlothauer (GHSVS.de). All rights reserved.
 * @license GNU General Public License version 3 or later; see LICENSE.txt
 * @authorUrl https://www.ghsvs.de
 * @link german description: https://www.ghsvs.de/programmierer-schnipsel/joomla/158-plugin-system-browser-title-by-ghsvs
 */
/**
...
class plgSystemBrowserTitleGhsvsInstallerScript extends InstallerScript
{
/*
...
*/
	 ...
	 * @return  void
	 *
	 * @since   version after 2019.11.13
	 */
 		...
 		try
 		{
 			...
 			$query->select('update_site_id')
 				...
 				->where($db->qn('location') . ' = '
 					. $db->q('http://snapshots.ghsvs.de/updates/joomla/plg_system_browsertitleghsvs.xml'));
